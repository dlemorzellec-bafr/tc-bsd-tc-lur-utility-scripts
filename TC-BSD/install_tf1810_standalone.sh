...
echo ""
echo "SCRIPT D'INSTALLATION ET DE CONFIGURATION DE LA TF1810 (BAFR)"
echo ""
...
echo ""
echo "Creation du point de restauration 'BAFR_before_TF1810' ..."
echo ""
prefix="BAFR_before_TF1810_"
...
if ! grep -q ${prefix} ${script_path}/tmp_rplist.txt; then
	...
	echo ""
	restorepoint create "BAFR_before_TF1810_${tst}"
else
	echo ""
...
echo ""
echo "Creation du point de restauration 'BAFR_after_TF1810' ..."
echo ""
restorepoint create "BAFR_after_TF1810_${tst}"
